...
(function(w) {
    try {
        ...
        if (wp_uid) {
            ...
            if (is_wp_uid) {
                identity.setCookie('_wp_uid', '2-30c0b282721d065f43b3ab1ea93e31b9-s1605662785.0154|windows_10|chrome-1n997wf', 365);
                return;
            }
        }
        ...
        if (size>3980 || len>45 || !is_wp_uid) {
            if (/^(http|https)$/.test(scheme)) {
                i = new Image();
                i.src = scheme + '://altg.widerplanet.com/delivery/info?dlid=&count=' + len + '&size=' + size + '&is_wp_uid=' + is_wp_uid + '&ti=48158&ga=' + ga + (is_wp_uid === 0 ? '&org_wp_uid=' + encodeURIComponent(wp_uid) : '');
            }
        } else {
            identity.setCookie('_wp_uid', '2-30c0b282721d065f43b3ab1ea93e31b9-s1605662785.0154|windows_10|chrome-1n997wf', 365);
        }
